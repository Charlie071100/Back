# Mi CV Digital - Práctica 1

Este proyecto es un currículum interactivo que creé a partir de una plantilla base de código. Organicé el proyecto dividiendo el contenido en HTML, los estilos visuales en un archivo CSS y usando algo de JavaScript para cambiar entre el modo claro y el modo oscuro de la página.
